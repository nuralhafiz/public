...
// Currently it is: updateApplicationStatus('${app.id}', 'approved')
// Need to change to: updateApplicationStatus('${app.id}', 'approved', '${app.userEmail}')
// We can use a simple regex replacing the exact string
